...
function Navbar() {
  ...
  return (
    <div className={`nav ${show ? "nav-black" : "nav-transParent"}`}>
      <div className="nav-sep">
        <div style={{ display: "flex" }}>
          <img
            ...
            className="img-logo"
          />
          <h1 className="Navhead">Home</h1>
          <h1 className="Navhead2">TV shows</h1>
          <h1 className="Navhead3">Movies</h1>
        </div>
        <img
